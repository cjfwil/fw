...
HRESULT CreateWin32FullscreenBorderlessWindow(HINSTANCE arg_hInstance)
{
    ...
    int x = CW_USEDEFAULT;
    int y = CW_USEDEFAULT;
    d3d11_window.hwnd = CreateWindowA(d3d11_window.windowClassName, "Cube11", WS_OVERLAPPEDWINDOW, x, y, (d3d11_window.rc.right - d3d11_window.rc.left), (d3d11_window.rc.bottom - d3d11_window.rc.top), 0, d3d11_window.hMenu, d3d11_window.hInstance, 0);
...
{
    HRESULT hr = S_OK;
    hr = CreateWin32FullscreenBorderlessWindow(arg_hInstance);
    if (SUCCEEDED(hr))
    {
